...
class EditDoctorDialog extends StatefulWidget {
  ...
  EditDoctorDialog({required this.doctor});

  @override
  _EditDoctorDialogState createState() => _EditDoctorDialogState();
}
  ...
  void _submitForm() {
    ...
    controller
        ...
        .then((_) {
          ...
          _showSuccessDialog(context, 'Doctor has been updated successfully.');
        })
        .catchError((e) {
          // Handle error
        });
