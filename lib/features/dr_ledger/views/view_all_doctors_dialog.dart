...
import 'edit_doctor_dialog.dart';

class ViewAllDoctorsDialog extends StatelessWidget {
  ...
  Widget _buildDoctorsTable() {
    if (controller.doctors.isEmpty) {
      return Center(
        child: Text('No doctors added yet.', style: AppStyles.bodyStyle),
      );
    }
          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child: DataTable(
                ...
                rows: controller.doctors.asMap().entries.map((entry) {
                  int index = entry.key;
                  ...
                  return DataRow(
                    cells: [
                      ...
                      DataCell(Text(doctor.name, style: AppStyles.bodyStyle)),
                      DataCell(
                        Text(
                      ...
                      DataCell(
                        Text(
                          doctor.phone.isEmpty ? 'N/A' : doctor.phone,
                          style: AppStyles.bodyStyle,
                        ),
                      ),
                      DataCell(
                        Text(
                          doctor.email.isEmpty ? 'N/A' : doctor.email,
                          style: AppStyles.bodyStyle,
                        ),
                      ),
                      DataCell(
  ...
  void _deleteDoctor(BuildContext context, int id) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: AppColors.background,
        title: Text('Delete Doctor', style: AppStyles.headingStyle),
        content: Text(
